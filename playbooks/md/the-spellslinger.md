...
(Ratings and Basic Moves Section placeholder)

## Luck

(Luck track placeholder)
...
- [x] **Tools and Techniques**: To use your combat magic effectively you rely on a collection of tools and techniques. Cross off one; you'll need the rest.
...
- [ ] **Arcane Reputation**: Pick three big organizations or groups in the supernatural community. They've heard of you and respect your power. With affected humans, take +1 forward when you **manipulate** them. You may **manipulate** affected monsters as if they were human, with no bonus.
- [ ] **Could've Been Worse**: When you miss a **use magic** roll, choose one of the following options instead of losing control of the magic: Fizzle or This Is Gonna Suck.
...
- [ ] **Enchanted Clothing**: Pick an article of everyday clothing—it's enchanted without any change in appearance. Take -1 harm from any source that tries to get at you through the garment.
- [ ] **Forensic Divination**: When you successfully **investigate a mystery**, ask "What magic was done here?" as a free extra question.
- [ ] **Go Big or Go Home**: When you must **use magic** as a requirement for Big Magic, take +1 ongoing to those **use magic** rolls.
- [ ] **Not My Fault**: +1 to **act under pressure** when dealing with the consequences of your own spell-casting.
...
You don't need much—aside from any foci or consumables to power your magic. Still, it's good to carry some backup.
Pick one:
...
- Rumpled clothes, stylish clothes, goth clothes, old fashioned clothes, __________ clothes.
- Shadowed eyes, fierce eyes, weary eyes, sparkling eyes, __________ eyes.
